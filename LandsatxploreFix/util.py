# module from https://github.com/yannforget/landsatxplore/blob/master/landsatxplore/util.py
...
def landsat_dataset(satellite, collection="c1", level="l1"):
    ...
    if satellite == 5:
        ...
        sensor = "ot"
#    elif satellite == 9 and collection == "c1":
#        sensor = "9"
    elif satellite == 9 and collection == "c2":
        sensor = "ot"
    else:
        raise LandsatxploreError("Failed to guess dataset from satellite identifier: " + str(satellite))
...
def guess_dataset(identifier):
    ...
    if _is_landsat_product_id(identifier):
        ...
        raise LandsatxploreError("Failed to guess dataset from scene identifier: " + identifier)
